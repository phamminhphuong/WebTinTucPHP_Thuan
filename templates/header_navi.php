...
<div style="padding-left: 70px;padding-top:10px;padding-bottom:0px;color:#B0006D; background-color:white;font-size:250%;font-family:Allura;">
  ...
  <div class="slogan">
      <b><i>&nbsp&nbsp&nbsp&nbspHaNoi University Library...</b></i>
  </div>
  </div>

  <div class="search" style="font-family: Delius">
      <form action="search.php" method="POST">
      <input type="text" placeholder="Search..." size="15" style="font-size:25px" name="key">&nbsp;
...
<body>
  ...
  <a href="feedback.php">Feedback</a>
    ...
    <div class = "right" style="font-size:25px;font-family:Annie Use Your Telescope;">
          ...
          ?>
          <a href="login.php" class="dropdown-toggle" data-toggle="dropdown"><?php echo 'Hi, '.$_SESSION['login_user']."!"; ?>

          <span class="caret"></span></button>
          <ul class="dropdown-menu" style="font-size: 20px;font-family: Delius">
            <li><a href="index.php"><i class="fa fa-user-o"></i>&nbsp;My Account</a></li>
            <li><a href="list.php"><i class="fa fa-wrench"></i>&nbsp;Admin Functions</a></li>
            <li><a href="logout.php"><i class="fa fa-window-close-o"></i>&nbsp;Log out</a></li>
          </ul>
          </a>
          <?php }else{ ?>
...
<div class="container">
  <div class="jumbotron" style="background-color: white; font-size: 20px;">
    <div class="col-sm-3 jum" style="font-family: Delius"><i class="fa fa-clock-o">&nbsp;Opening 7am - 6pm</i></div>
    <div class="col-sm-3 jum" style="font-family: Delius"><i class="fa fa-phone">&nbsp;Hotline 0969725813</i></div>
  </div>
  </div>
</div>
</body>
